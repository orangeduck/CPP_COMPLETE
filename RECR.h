...
#define RECR_D1000($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1001($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1002($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1003($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1004($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1005($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1006($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1007($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1008($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1009($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1010($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1011($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1012($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1013($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1014($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1015($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1016($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1017($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1018($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1019($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1020($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1021($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1022($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
#define RECR_D1023($, C, M, U, E, X) JOIN(RECR_A, $)(INC($), C, M, U, E, X)
...
#define RECR_A1000($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1001($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1002($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1003($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1004($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1005($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1006($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1007($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1008($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1009($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1010($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1011($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1012($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1013($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1014($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1015($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1016($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1017($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1018($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1019($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1020($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1021($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1022($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
#define RECR_A1023($, C, M, U, E, X) IF_ELSE( C($, X), M($, X) JOIN(RECR_D, $)(KICK(C($, X), $), C, M, U, E, U($, X)), E($, X) )
